...
│
├── design/                          ← visual assets (project, non-gate)
│   ├── design.md                    # the "why" — tone & principles
│   ├── tokens.md                    # the values (single SoT — you edit this)
│   └── tokens.css | theme.css       # generated by goal from tokens.md (don't edit)
│
...
| `init.sh` · `.gitmessage` · `rules.json` · `design/` | this `README.md` (= SFD's methodology doc, not yours) |
